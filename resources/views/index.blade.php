                    ...
                    <div class="col">
                        <div class="intro-content" style="--margin-left: 4rem;">
                            <div class="section-heading shm-none">
                                <div class="section-subheading">MYCLETH</div>
                                <h1>Haz crecer tu negocio</h1>
                                <p class="section-desc">Fomentamos el crecimiento y desarrollo de nuestros clientes al
                                    optimizar sus recursos de IT poniendo a su servicio más de 10años de experiencia con un
                                    alto nivel de profesionalismo y pasión por la tecnología y el desarrollo.</p>
                            </div>
            ...
            <div class="row">
                <header class="col-12">
                    <div class="section-heading heading-center">
                        <div class="section-subheading">Áreas de desarrollo</div>
                ...
                <div class="col-lg-4 col-md-6 col-12 item">
                    <a href="#!" class="iitem item-style iitem-hover">
                        ...
                        <h3 class="iitem-heading item-heading-large">Desarrollo de software</h3>
                        <div class="iitem-desc">Contrary to popular belief, Lorem Ipsum is not simply random text. It has
                            roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-12 item">
                    <a href="#!" class="iitem item-style iitem-hover">
                        ...
                        <div class="iitem-desc">Contrary to popular belief, Lorem Ipsum is not simply random text. It has
                            roots in a piece of classical Latin literature from 45 BC, making it.</div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-12 col-12 item">
                    <a href="#" class="iitem item-style iitem-hover">
                        ...
                        <h3 class="iitem-heading item-heading-large">E - Commerce</h3>
                        <div class="iitem-desc">There are many variations of passages of Lorem Ipsum available, but the
                            majority have suffered alteration in some form, by injected humour, or randomised words.</div>
                    </a>
                </div>
