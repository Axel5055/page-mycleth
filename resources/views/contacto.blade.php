...
<div class="section">
    ...
    <div class="col-xl-8 col-md-7 content-item">
        <form action="{{route('contacto.store')}}" method="POST" class="form-submission contact-form contact-form-padding" novalidate>
            @csrf
            ...
            <div class="row gutters-default">
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="form-field">
                        ...
                        <input type="text" class="form-field-input" name="name" value="" autocomplete="off" id="contact-name" required data-pristine-required-message="Este campo es obligatorio.">
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="form-field">
                        ...
                        <input type="text" class="form-field-input" name="empresa" value="" autocomplete="off" id="contact-name" data-pristine-required-message="Este campo es obligatorio.">
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="form-field">
                        ...
                        <input type="tel" class="form-field-input mask-phone" name="telefono" value="" autocomplete="off" id="contact-phone" required data-pristine-required-message="Este campo es obligatorio.">
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-12">
                    <div class="form-field">
                        ...
                        <input type="email" class="form-field-input" name="correo" value="" autocomplete="off" id="contact-email" required data-pristine-required-message="Este campo es obligatorio." data-pristine-email-message="Please enter a valid email address.">
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-12">
                    <div class="form-field">
                        ...
                        <input type="text" class="form-field-input" id="service-type" name="plan" list="service-options" autocomplete="off" required data-pristine-required-message="Este campo es obligatorio." data-pristine-email-message="Please select a plan.">
                ...
                <div class="col-12">
                    <div class="form-field">
                        ...
                        <textarea name="mensaje" class="form-field-input" id="contact-message" cols="30" rows="6"></textarea>
                    </div>
